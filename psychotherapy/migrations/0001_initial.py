# Generated by Django 3.2.2 on 2023-04-26 11:23
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('q_t_chief_complaint', models.CharField(choices=[('1', 'I feel Stress and Anxiety (constant worry).'), ('2', 'I have problems due to specific medications, drugs, or alcohol.'), ('3', 'I"m hyperactive, and I feel euphoric.'), ('4', 'I experience distress due to my education/occupation.'), ('5', 'I experience overthinking, obsessive thoughts, and behaviors.'), ('6', 'I am in the process of immigrating, or I have been immigrating for many years, and I need to speak with a Persian-speaking therapist due to Immigration Issues.'), ('7', ' I experience sexual impairment and issues.'), ('8', 'I intend to get married, and I want to make the right decision.'), ('9', 'I have some issues in my relationship/family.'), ('10', 'I’m going to be a father or mother for the first time and talk to a therapist about my concerns (parenting, pregnancy, etc.)'), ('11', 'I have experienced hallucinations or delusions.'), ('12', 'I feel depressed, exhausted, and unmotivated.'), ('13', 'I experience mental distress due to medical conditions such as MS, Cardiovascular Disease, etc.'), ('14', 'I have a traumatic experience or an unfortunate event that has dramatically affected my feelings and life. (Grief, Sexual Abuse, bankruptcy, etc.) ')], max_length=5, null=True)),
                ...
                ('q_t_initial_opinion', models.TextField(default='', max_length=250)),
            ],
            options={
                'ordering': ['-id'],
            },
